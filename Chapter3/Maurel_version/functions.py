...
def CRM_acq(X, V):
    ...
    fields_list_muT = np.array([50., 75, 100., 150.])
    ...
    for ct in range(len(field_arr)): #(field < (fieldmax)): 
        ...
        num_hyss = 100000 #300000 #hysteron_list[count_no]
        V['num_hyss'] = num_hyss       
        ...
        t = t - tstep
        print('blocked at 350', temp, V['blockper'])
        rate = 0
        V['rate'] = rate
        tm = 60
        V['tm'] = tm
        ...
        print('blocked RT', temp, V['blockper'])
        ...
        #heat SIRM to 350 degrees and cool back down 
        #V['sirm'][ifield,0] = V['totalm']
        print('SIRM RT', V['totalm'], V['blockper'])
        V['temp'] = 350. + 273. 
        V['beta'] = (1-((temp-273)/578.0))**0.43 #MATCH TO INPUTTED CURIE T
        
        blockfind_SC(t, fieldzero, afzero, V, X)

        print('SIRM 350', V['totalm'], V['blockper'])

        V['temp'] = 300. 
        V['beta'] = (1-((temp-273)/578.0))**0.43 #MATCH TO INPUTTED CURIE T
        blockfind_SC(t, fieldzero, afzero, V, X)
        print('SIRM cooled', V['totalm'], V['blockper'])
